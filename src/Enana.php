...
class Enana
{
    ...
    public function __construct($a1, $a2)
    {
        ...
        $this->nombre = $a1; // NOMBRE DE LA ENANA
        $this->puntosVida = $a2; // PUNTOS DE VIDA

        if ($this->puntosVida == 0) {
            $this->situacion = "limbo"; // VIDA = 0
        } else {
            if ($this->puntosVida < 0) {
                $this->situacion = "muerta"; // VIDA MENOR A 0
            } else {
                $this->situacion = "viva"; // VIDA MAYOR A 0
            }
        }
    ...
    public function pocima()
    {
        ...
        if ($this->situacion != "limbo") {
            ...
            if($this->situacion=="muerta"){$this->situacion="viva";}
        }
